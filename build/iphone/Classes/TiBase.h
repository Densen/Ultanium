...
// in simulator we redefine to format for Ultanium Developer console
...
{\
	NSString * exceptionName = [@"org.ultanium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ultanium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIUltaniumNativeItemNone = -1, 
	UIUltaniumNativeItemSpinner = -2,
	UIUltaniumNativeItemProgressBar = -3,
	
	UIUltaniumNativeItemSlider = -4,
	UIUltaniumNativeItemSwitch = -5,
	UIUltaniumNativeItemMultiButton = -6,
	UIUltaniumNativeItemSegmented = -7,
	
	UIUltaniumNativeItemTextView = -8,
	UIUltaniumNativeItemTextField = -9,
	UIUltaniumNativeItemSearchBar = -10,
	
	UIUltaniumNativeItemPicker = -11,
	UIUltaniumNativeItemDatePicker = -12,
	
	UIUltaniumNativeItemInfoLight = -13,
	UIUltaniumNativeItemInfoDark = -14,
	
	UIUltaniumNativeItemDisclosure = -15,
	
	UIUltaniumNativeItemContactAdd = -16
};
