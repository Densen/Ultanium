...
@interface UltaniumObject : NSObject
@end

@interface UltaniumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UltaniumObject class]])
		{
			for (NSString *key in [[(UltaniumObject*)o modules] allKeys])
			{
